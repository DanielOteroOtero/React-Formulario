...
const Formulario = () => {
  ...
  return (
    <div>
      <h2 className="text-center text-primary">Formulario de Creación de Usuarios</h2>
      ...
      <h2 className="text-center text-primary mt-5">Lista de Usuarios Registrados</h2>
